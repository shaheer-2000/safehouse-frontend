        ...
        <React.Fragment>
            <form action="" onSubmit={handleSubmit}>
                <table>
                    ...
                    <tr>
                        <td align="right">
                            <label htmlFor="coverage">Coverage in percentage </label>
                            </td>
                            <td>
                                <input type="number" required autoComplete="off" value={userRegisteration.coverage} onChange={handleInput} name="coverage" id="coverage"/>
                            </td>
                    </tr>
                    <tr>
                        <td align="right">
                            <label htmlFor="subscriptioncharges">Subscription Charges </label>
                        </td>
                        <td>
                            <input type="number" required autoComplete="off" value={userRegisteration.subscriptioncharges} onChange={handleInput} name="subscriptioncharges" id="subscriptioncharges"/>
                        </td>
                    </tr>
                    <tr>
                        <td align="right">
